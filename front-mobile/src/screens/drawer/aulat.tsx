...
export default function Aulat() {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View>
            <Text>Aprenda a dar os primeiros passos na criação de um vídeo. Explore ferramentas básicas, escolha de equipamentos e técnicas práticas para começar a produzir seus próprios conteúdos.
